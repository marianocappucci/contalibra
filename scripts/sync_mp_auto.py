...
# resto del repo el insert se saco al empaquetar (2026-07-31), porque ahi
# sobraba; aca es lo unico que sostiene el import y hay un test que lo
# vigila (tests/test_layout_paquete.py).
