"""Log de actividad y de autenticación de Contalibra.
...
orígenes (ventas y stock) leen tablas que en Contalibra ya no son la fuente
de verdad** desde P7: las ventas viven en `sales` y el stock en
...
toca** — Restolibra sigue funcionando igual.
"""
