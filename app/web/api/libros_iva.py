"""API JSON de Libros IVA para la SPA (ver wiki/entities/contalibra.md,
migracion a React). Reusa `db_libros_iva.py` y la logica de resumen de
`web/routers/libros_iva.py` (importada tal cual, sin duplicarla) -- ver
web/api/clientes.py para el patron general de esta etapa. Los exports
REGINFO (`GET /libros-iva/export/*`) siguen en `web/routers/libros_iva.py`
sin tocar, la SPA los linkea directo."""
import datetime
