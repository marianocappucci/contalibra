"""API JSON de Egresos para la SPA (ver wiki/entities/contalibra.md,
...
correspondiente, igual que el router HTML -- necesita leer `cajas` (modulo
"Caja/Cajas", Etapa C) solo para poblar el selector de destino del pago,
sin exponer un CRUD de cajas aca.
"""
import datetime
