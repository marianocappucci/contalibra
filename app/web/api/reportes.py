"""API JSON de Reportes para la SPA (ver wiki/entities/contalibra.md,
migracion a React). Reusa `db_reportes.py` y los helpers de pivot de
`web/routers/reportes.py` (importados tal cual, sin duplicarlos) -- ver
web/api/clientes.py para el patron general de esta etapa. Los exports CSV
(`GET /reportes/export/*`, `GET /reportes/caja-medios/export`) siguen en
`web/routers/reportes.py` sin tocar, la SPA los linkea directo."""
import datetime
