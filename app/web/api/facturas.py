"""API JSON de Facturas (ARCA) para la SPA (ver
wiki/entities/contalibra.md, migracion a React). Reusa `db_facturas.py`,
`web/helpers/form_helper.py::calculate_totals` y
`web/helpers/arca_helper.py` (numeracion + CAE) tal cual -- ver
