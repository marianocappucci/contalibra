...
# Las paginas Jinja2 de este router (list/nuevo/editar/detail/estado/
# enviar-email/eliminar) se removieron en el corte de la migracion a
# React -- ver wiki/entities/contalibra.md, Etapa D. Solo queda la
