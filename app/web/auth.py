...
_auth = SessionAuth(
    dev_secret_fallback="contalibra-secret-change-me",
...
#: `cl_session`, asi que la sesion de un usuario logueado no se invalida al
#: pasar del router propio al del motor.
session_auth = _auth
