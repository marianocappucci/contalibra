...
# tabla de eventos propia — limitador en memoria del propio proceso, alcanza
# porque el backoffice corre como un único proceso systemd. Se resetea si el
# proceso reinicia — aceptable para este panel de bajo tráfico. Mismo fix
# que Restolibra (fork downstream).
