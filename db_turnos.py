"""Turnos de caja de Contalibra.

El dominio de turnos sigue siendo de LibraCore (caja/tesorería, no se migra
en P7) — pero **tres de sus funciones leen o escriben la tabla `ventas`**,
que en Contalibra ya no es la fuente de verdad: las ventas viven en
`sales`/`sale_items` de LibraCommerce desde P7 (ver `db_ventas.py`).
...
cual, y **LibraCore no se toca** para que Restolibra siga funcionando igual.
