...
(`0003_created_at_hora_ar`, v1.97.0 y anteriores) que arma la lista a mano de
columnas con reloj. Nace ya con el default correcto —
...
Va en la cadena propia de Contalibra y no en la del motor porque
...
revision = "0003_cierres_diarios_hora_ar"
down_revision = "0002_cliente_lista_precio"
branch_labels = None
depends_on = None
