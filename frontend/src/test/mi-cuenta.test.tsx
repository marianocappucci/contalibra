...
// `PUT /api/usuarios/me/password` (cambiaba la propia contraseña SIN pedir
// la actual) y pasó a `POST /api/change-password`, que sí la pide. Ver
// `pages/MiCuenta.tsx`.
...
describe('Mi cuenta', () => {
  it('pide la contraseña actual y la manda junto con la nueva a /api/change-password', async () => {
    ...
    // Ya NO existe ningún pedido al endpoint viejo.
