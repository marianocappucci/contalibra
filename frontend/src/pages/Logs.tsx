...
// ver git 1a8808c:web/routers/logs.py).
...
export function Logs() {
  ...
  // Agrupar la actividad por fecha para mostrar un separador, igual que
  // hacia la version Jinja2 vieja (web/templates/admin/logs.html).
