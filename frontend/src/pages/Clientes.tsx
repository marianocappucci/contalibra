...
export function Clientes() {
  ...
  // Alta de cliente como Dialog inline -- antes era la página /clientes/nuevo
  // (ClienteForm.tsx, ahora eliminada). Ver web/templates/clientes/form.html
  // para el origen de estos campos/validaciones.
  ...
  // mismo texto de confirmación y verbo que usaba la página vieja, ahora vía
  ...
  // badge junto al nombre, igual que acá). "Ver" navega a la página propia
  // (/clientes/:id); "Editar" ahora abre el modal de edición inline en esa
