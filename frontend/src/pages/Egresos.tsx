...
// Alta ahora vive como Dialog inline (antes era la página propia
// EgresoNuevo.tsx en /egresos/nuevo, igual que web/templates/egresos/form.html
// -- solo alta, la edición nunca tuvo punto de entrada en la UI vieja).
