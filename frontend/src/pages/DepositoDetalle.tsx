...
// "Editar" acá abre el mismo Dialog que en Depositos.tsx (antes navegaba a
// /depositos/:id/editar, página propia DepositoForm.tsx). Implementación
// independiente porque este Dialog vive en la página de detalle, no en el
// listado -- ambos puntos de entrada al edit existían en la UI vieja.
