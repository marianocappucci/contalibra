...
import { Check, Package, Plus, Printer, Receipt, Send, Tag, Trash2 } from 'lucide-react'
 ...
 *  este producto y en Restolibra, y en los otros seis no: subirlo al kit
...
export function EmailCard() {
  ...
  return (
    <div className="grid gap-4">
      <EmailDelKit producto="Contalibra" basePath="/api/config/smtp" />
