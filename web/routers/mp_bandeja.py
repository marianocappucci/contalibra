...
async def mp_sincronizar(request: Request, _: Auth,
    ...
    for pago in movimientos:
        ...
        # bancarias entrantes reales de un cliente (confirmado 2026-07-14:
        # una transferencia real de $125.000 quedaba invisible) — y lo
        # mismo puede pasar si el cliente arma la transferencia con una
        # tarjeta de crédito como origen de fondos. No hay forma confiable
        # de distinguir "cliente transfiriéndome" de "yo moviendo plata
        # entre mis propias cuentas" solo con estos campos — a pedido
