...
async def nc_crear(factura_id: int, user: Auth, _role: RoleAdmin):
    ...
    if orig.get("condicion_venta") == "Cuenta Corriente":
        ...
        # revés, ya corregido, para el cobro CC). Mismo mecanismo que un pago
        # manual a cuenta (cc_pagar): un cc_pagos que resta del saldo en
        # get_cc_saldo/get_clientes_con_saldo_cc.
