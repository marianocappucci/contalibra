...
1. 🔴 **Que la instancia de un cliente no anuncie ninguna demo** y que nadie
   entre por ahi. Contalibra factura con clientes reales: aca "cualquiera entra
...
def test_los_campos_del_producto_viajan_en_la_respuesta(app_con):
    ...
    for campo in ("nombre", "modulos", "empresa_nombre",
                  "mp_pending_count", "comprobantes_pendientes_count"):
