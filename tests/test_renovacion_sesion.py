...
Contalibra **no usa** la dependencia del motor (`json_api_get_current_user`):
...
def test_sesion_de_8_horas_sin_uso_se_rechaza(client, reloj):
    """Cambio de comportamiento de ADR-017: antes la cookie de Contalibra
