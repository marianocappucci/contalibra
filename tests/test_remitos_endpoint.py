"""El router de remitos de Contalibra, ahora armado por el factory de libracore.

Smoke end-to-end del wiring: que el factory (con la auth y el PDF de Contalibra
...
def test_crear_y_leer_remito(admin_client):
    ...
    assert remito["pdf_path"]  # el generar_pdf de Contalibra corrió
