...
Mismo fix que Restolibra (fork downstream) — ver
wiki/analyses/restolibra-auditoria-produccion, hallazgo Medio: sin headers
...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request, call_next):
        ...
        # Si algún día se sirve HTTP directo esto rompería ese acceso, pero
        # hoy no existe ese caso.
